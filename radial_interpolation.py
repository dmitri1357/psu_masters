...
def define_input_grid(array_latmin, array_latmax, array_latstep,
    ...
    return array_lats, array_lons


def build_radial_grid(center_lat, center_lon, start_dist,
                      dist_step, end_dist, degree_resolution):
    """
    center_lat = central latitude point around which the unit circle interpolator will be built
    center_lon = central longitude point around which the unit circle interpolator will be built
...
def radial_interp(array, array_lats, array_lons, latvec, lonvec):
    """
